...
#include "BaseNode.h"
#include "BaseExtendData.h"

const int EZWEIQI_PIECE_SIZE = 32;
const int EZWEIQI_OUTBOARD_PIECE_SIZE = 14;
...
*/
class EzWeiQiPiece : public BaseExtendData
{
public:
...
// Conversiont functions
	...
	將value/iPieceSize後四捨五入，在乘iPieceSize
